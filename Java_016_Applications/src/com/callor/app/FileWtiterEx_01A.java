...
public class FileWtiterEx_01A {
	public static void main(String[] args) {
		 ...
		 * 타이핑을 직접하다 보면 오타가 발생할 수 있기 때문에
		 * Copy Qualified Name을 사용하여 임의 파일 이름을 가져오고
		...
		//fileWriter, PtintWriter를 객체로 선언
		...
		try {
			...
			//System.out 의 print 관련 메소드와 똑같은 방법으로 파일에 text들을 저장한다.
			...
			//PrintWriter를 닫으면 FileWriter도 같이 닫히기 때무에
