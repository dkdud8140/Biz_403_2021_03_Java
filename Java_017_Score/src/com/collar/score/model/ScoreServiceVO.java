package com.collar.score.model;
 ...
 * 연산을 수행항 후 데이터를 Getter하는 방식으로 활용한다.
 * 
...
public class ScoreServiceVO {
	
	private String num ;
	private String name;
	
	/*
	 * VO 클래스에 숫자형변수를 선언할 때
	 ...
	 * 당연히 잘 계산된 총점 결과르 ㄹ 알려준다는 것을 알고 있다.
	 * 
	...
	public String toString() {
		return "ScoreServiceVO [num = " + num + ", name = " + name + ", kor = " + kor + ", eng = " + eng + ", math = " + math
				+ ", totale = " + this.getTotal() + ", avg = " + this.getAvg() + "]";
	}
