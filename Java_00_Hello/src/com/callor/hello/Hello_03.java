...
/*
 * 숫자연산
 * java에서는 사칙연상과 나머지 연산을 수행할 수 있다
 * 
 * 숫자가 정수일때는 4칙 연상의 결과가 모두 정수이다
...
public class Hello_03 {
	...
	public static void main(String[] args) {
		...
		//java에서 실수의 표현 1
		//java는 실수를 표현할 때 10의 -16승까지 표현한다
		//소수점이하 16자리까지 표현하고 이후 값은 무시 또는 반올림 등을 수행한다.
		System.out.println(40.0/30.);
		
		//정수와 실수의 연산
		//정수와 실수가 섞여있는 연산식에서는 모든 숫자를 실수로 변경하여 연산이 수행
		System.out.println(40 / 30.0);
		System.out.println(40.0/30);
		
		
		//숫자 뒤에 f 혹은 F를 적으면 단축형 실수가 된다.
		//단축형 실수 : 소숫점 이하 7번째자리만 인식한다.
		System.out.println(40F/30F);
		System.out.println(40f/30f);
		
		//단정도 실수 : 소수 이하 7번째(6)자리까지 표현하는 실수
		//배정도 실수 : 단정도 실수의 2배 이상 자리까지 표현한 실수
		//고정소수점 연산(값) : 정수는 소수점이하 0번째 자리에서 반올림한다
