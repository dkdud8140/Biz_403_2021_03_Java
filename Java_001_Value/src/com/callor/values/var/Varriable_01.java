...
public class Varriable_01 {
	public static void main(String[] args) {
		 ...
		 * 5. + 기호를 분석하여 두 숫자의 덧셈을 계산하라는 명령을 인식
		 * 6. 두 수를 덧셈장치(Adder)에 보내서 덧셈을 수행
		 * 7. 덧셈한 결과를 기억장치 어딘가에 보관
		 * 8. println()에게 덧셈결과가 보관된 기억장소 위치(주소)를 알려준다.
		 * 9. println()은 덧셈결과가 보관된 기억장소를 찾아가서 보관 값을 가져와서 System.out 한테 보낸다.
		...
		/*
		 * 위 다섯가지의 명령코드에서 숫자 30과 40, 그리고 연산 결과는 기억장치 어딘가에 (임시로) 보관이 되어 연산 수행이 이루어진다.
		 ...
		 * 
		 * 30과 40이라는 두 숫자를 어떤 지정된 기억장소에 보관해 두고 연산할 떄 그 값을 참조하여 연산을 하도록 한다면
		 * 기억장치를 효율적으로 사용할 수 있을 것이다.
		 * 
		 * 이러한 개념을 발전 시킨 것을 "변수(Varriable)"이라고 한다.
		 * 
		 * 
		 */
